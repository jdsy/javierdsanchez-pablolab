...
load('Z:\group\measurements\leonardo\Bi_layer_device\BN_01_11_11_BN14\He3_measurements\pn1\ScansDC\Buffer_Rack_v2.mat');  %rack v5 has corrections to DAC
...
smdata.inst(dacind).data.inst = serial('COM4');
...
cd('Z:\group\measurements\leonardo\Bi_layer_device\BN_01_11_11_BN14\He3_measurements\pn1');
smgui;